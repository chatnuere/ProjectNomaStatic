            ...
            content +='<div class="articleCarousel item">'+
                    ...
                    '<div class="content">'+
                        '<nav class="social">'+
                            '<p>Partager</p>'+
                            '<ul>'+
                                '<li><a class="windowed"  href="http://twitter.com/intent/tweet/?url='+encodeURIComponent(articleUrl)+'&text='+articleTitle+'"><i class="icon-twitter"></i></a></li><!--'+
                             '--><li><a class="windowed"  href=https://www.facebook.com/sharer/sharer.php?u="'+encodeURIComponent(articleUrl)+'"><i class="icon-facebook"></i></a></li><!--'+
